...
export default function CTASection() {
  return (
    ...
    >
      ...
      {/* Decorative Elements */}
      <div className="absolute right-10 top-10 hidden h-24 w-24 rounded-full border border-emerald-400/20 sm:block" />
      <div className="absolute bottom-10 left-10 hidden h-16 w-16 rounded-full border border-cyan-400/20 sm:block" />
      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-300">
          Whether you're looking to discover opportunities, connect with
          young talent, or learn more about Funngro, we're here to help.
        </p>
